...
unsigned long CRTPacket::GetTimeStamp()
{
    if (GetType() == PacketData)
    {
...
unsigned long CRTPacket::GetTimeStamp(char* pData, bool bBigEndian)
{
...
unsigned int CRTPacket::GetComponentSize(EComponentType eComponent)
{
    ...
    if (mpComponentData[eComponent] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[eComponent]));
}
...
{
    if (mpComponentData[Component3d] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component3d] + 8));
}
...
bool CRTPacket::Get3DMarker(unsigned int nMarkerIndex, float &fX, float &fY, float &fZ)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX = SetByteOrder((float*)(mpComponentData[Component3d] + 16 + nMarkerIndex * 12));
        fY = SetByteOrder((float*)(mpComponentData[Component3d] + 20 + nMarkerIndex * 12));
        fZ = SetByteOrder((float*)(mpComponentData[Component3d] + 24 + nMarkerIndex * 12));
        if (isnan(fX))
        {
            return false;
        }
    ...
    {
        fX = (float)SetByteOrder((double*)(mpComponentData[Component3d] + 16 + nMarkerIndex * 24));
        fY = (float)SetByteOrder((double*)(mpComponentData[Component3d] + 24 + nMarkerIndex * 24));
        fZ = (float)SetByteOrder((double*)(mpComponentData[Component3d] + 32 + nMarkerIndex * 24));
        if (isnan(fX))
        {
            return false;
        }
...
{
    if (mpComponentData[Component3dRes] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component3dRes] + 8));
}
...
bool CRTPacket::Get3DResidualMarker(unsigned int nMarkerIndex, float &fX, float &fY, float &fZ, float &fResidual)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX        = SetByteOrder((float*)(mpComponentData[Component3dRes] + 16 + nMarkerIndex * 16));
        fY        = SetByteOrder((float*)(mpComponentData[Component3dRes] + 20 + nMarkerIndex * 16));
        fZ        = SetByteOrder((float*)(mpComponentData[Component3dRes] + 24 + nMarkerIndex * 16));
        fResidual = SetByteOrder((float*)(mpComponentData[Component3dRes] + 28 + nMarkerIndex * 16));
        if (isnan(fX))
        {
            return false;
        }
    ...
    {
        fX        = (float)SetByteOrder((double*)(mpComponentData[Component3dRes] + 16 + nMarkerIndex * 32));
        fY        = (float)SetByteOrder((double*)(mpComponentData[Component3dRes] + 24 + nMarkerIndex * 32));
        fZ        = (float)SetByteOrder((double*)(mpComponentData[Component3dRes] + 32 + nMarkerIndex * 32));
        fResidual =        SetByteOrder((float*) (mpComponentData[Component3dRes] + 40 + nMarkerIndex * 32));
        if (isnan(fX))
        {
            return false;
        }
...
{
    if (mpComponentData[Component3dNoLabels] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component3dNoLabels] + 8));
}
...
bool CRTPacket::Get3DNoLabelsMarker(unsigned int nMarkerIndex, float &fX, float &fY, float &fZ, unsigned int &nId)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX  = SetByteOrder((float*)(mpComponentData[Component3dNoLabels] + 16 + nMarkerIndex * 16));
        fY  = SetByteOrder((float*)(mpComponentData[Component3dNoLabels] + 20 + nMarkerIndex * 16));
        fZ  = SetByteOrder((float*)(mpComponentData[Component3dNoLabels] + 24 + nMarkerIndex * 16));
        nId = SetByteOrder((unsigned int*)(mpComponentData[Component3dNoLabels] + 28 + nMarkerIndex * 16));
    }
    else
    {
        fX  = (float)SetByteOrder((double*)(mpComponentData[Component3dNoLabels] + 16 + nMarkerIndex * 32));
        fY  = (float)SetByteOrder((double*)(mpComponentData[Component3dNoLabels] + 24 + nMarkerIndex * 32));
        fZ  = (float)SetByteOrder((double*)(mpComponentData[Component3dNoLabels] + 32 + nMarkerIndex * 32));
        nId =  SetByteOrder((unsigned int*)(mpComponentData[Component3dNoLabels] + 40 + nMarkerIndex * 32));
    }
    return true;
}
...
{
    if (mpComponentData[Component3dNoLabelsRes] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component3dNoLabelsRes] + 8));
}
                                            ...
                                            unsigned int &nId, float &fResidual)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX        = SetByteOrder((float*)(mpComponentData[Component3dNoLabelsRes] + 16 + nMarkerIndex * 20));
        fY        = SetByteOrder((float*)(mpComponentData[Component3dNoLabelsRes] + 20 + nMarkerIndex * 20));
        fZ        = SetByteOrder((float*)(mpComponentData[Component3dNoLabelsRes] + 24 + nMarkerIndex * 20));
        nId       = SetByteOrder((unsigned int*)(mpComponentData[Component3dNoLabelsRes] + 28 + nMarkerIndex * 20));
        fResidual = SetByteOrder((float*)(mpComponentData[Component3dNoLabelsRes] + 32 + nMarkerIndex * 20));
    }
    else
    {
        fX        = (float)SetByteOrder((double*)(mpComponentData[Component3dNoLabelsRes] + 16 + nMarkerIndex * 32));
        fY        = (float)SetByteOrder((double*)(mpComponentData[Component3dNoLabelsRes] + 24 + nMarkerIndex * 32));
        fZ        = (float)SetByteOrder((double*)(mpComponentData[Component3dNoLabelsRes] + 32 + nMarkerIndex * 32));
        nId       =  SetByteOrder((unsigned int*)(mpComponentData[Component3dNoLabelsRes] + 40 + nMarkerIndex * 32));
        fResidual =        SetByteOrder((float*) (mpComponentData[Component3dNoLabelsRes] + 44 + nMarkerIndex * 32));
    }
    return true;
}
...
{
    if (mpComponentData[Component6d] == NULL)
    {
		//printf("get6dof bdycount failed...\n");
        return 0;
    }
    //printf("set byte order???\n");
    return SetByteOrder((unsigned int*)(mpComponentData[Component6d] + 8));
}
...
bool CRTPacket::Get6DOFBody(unsigned int nBodyIndex, float &fX, float &fY, float &fZ, float afRotMatrix[9])
{
    ...
    {
		//printf("first if\n");
        fX = SetByteOrder((float*)(mpComponentData[Component6d] + 16 + nBodyIndex * 48));
        fY = SetByteOrder((float*)(mpComponentData[Component6d] + 20 + nBodyIndex * 48));
        fZ = SetByteOrder((float*)(mpComponentData[Component6d] + 24 + nBodyIndex * 48));
        for (int i = 0; i < 9; i++)
        {
            afRotMatrix[i] = SetByteOrder((float*)(mpComponentData[Component6d] + 28 + (i * 4) + nBodyIndex * 48));
        }
    }
    else
    {
		//printf("else\n");
        fX = (float)SetByteOrder((double*)(mpComponentData[Component6d] + 16 + nBodyIndex * 96));
        fY = (float)SetByteOrder((double*)(mpComponentData[Component6d] + 24 + nBodyIndex * 96));
...
{
    if (mpComponentData[Component6dRes] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component6dRes] + 8));
}
                                    ...
                                    float afRotMatrix[9], float &fResidual)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX = SetByteOrder((float*)(mpComponentData[Component6dRes] + 16 + nBodyIndex * 52));
        fY = SetByteOrder((float*)(mpComponentData[Component6dRes] + 20 + nBodyIndex * 52));
        fZ = SetByteOrder((float*)(mpComponentData[Component6dRes] + 24 + nBodyIndex * 52));
        for (int i = 0; i < 9; i++)
        {
            afRotMatrix[i] = SetByteOrder((float*)(mpComponentData[Component6dRes] + 28 + (i * 4) + nBodyIndex * 52));
        }
        fResidual = SetByteOrder((float*)(mpComponentData[Component6dRes] + 64 + nBodyIndex * 52));
    }
    else
    {
        fX = (float)SetByteOrder((double*)(mpComponentData[Component6dRes] + 16 + nBodyIndex * 104));
        fY = (float)SetByteOrder((double*)(mpComponentData[Component6dRes] + 24 + nBodyIndex * 104));
        fZ = (float)SetByteOrder((double*)(mpComponentData[Component6dRes] + 32 + nBodyIndex * 104));
        for (int i = 0; i < 9; i++)
        {
            afRotMatrix[i] = (float)SetByteOrder((double*)(mpComponentData[Component6dRes] + 40 + (i * 8) + nBodyIndex * 104));
        }
        fResidual = SetByteOrder((float*)(mpComponentData[Component6dRes] + 112 + nBodyIndex * 104));
    }
    return true;
}
...
{
    if (mpComponentData[Component6dEuler] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component6dEuler] + 8));
}
                                 ...
                                 float &fAng1, float &fAng2, float &fAng3)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX    = SetByteOrder((float*)(mpComponentData[Component6dEuler] + 16 + nBodyIndex * 24));
        fY    = SetByteOrder((float*)(mpComponentData[Component6dEuler] + 20 + nBodyIndex * 24));
        fZ    = SetByteOrder((float*)(mpComponentData[Component6dEuler] + 24 + nBodyIndex * 24));
        fAng1 = SetByteOrder((float*)(mpComponentData[Component6dEuler] + 28 + nBodyIndex * 24));
        fAng2 = SetByteOrder((float*)(mpComponentData[Component6dEuler] + 32 + nBodyIndex * 24));
        fAng3 = SetByteOrder((float*)(mpComponentData[Component6dEuler] + 36 + nBodyIndex * 24));
    }
    else
    {
        fX    = (float)SetByteOrder((double*)(mpComponentData[Component6dEuler] + 16 + nBodyIndex * 48));
        fY    = (float)SetByteOrder((double*)(mpComponentData[Component6dEuler] + 24 + nBodyIndex * 48));
        fZ    = (float)SetByteOrder((double*)(mpComponentData[Component6dEuler] + 32 + nBodyIndex * 48));
        fAng1 = (float)SetByteOrder((double*)(mpComponentData[Component6dEuler] + 40 + nBodyIndex * 48));
        fAng2 = (float)SetByteOrder((double*)(mpComponentData[Component6dEuler] + 48 + nBodyIndex * 48));
        fAng3 = (float)SetByteOrder((double*)(mpComponentData[Component6dEuler] + 56 + nBodyIndex * 48));
    }
    return true;
}
...
{
    if (mpComponentData[Component6dEulerRes] == NULL)
    {
        return 0;
    }
    return SetByteOrder((unsigned int*)(mpComponentData[Component6dEulerRes] + 8));
}
                                         ...
                                         float &fAng1, float &fAng2, float &fAng3, float &fResidual)
{
    ...
    if (mnMajorVersion > 1 || mnMinorVersion > 7)
    {
        fX        = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 16 + nBodyIndex * 28));
        fY        = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 20 + nBodyIndex * 28));
        fZ        = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 24 + nBodyIndex * 28));
        fAng1     = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 28 + nBodyIndex * 28));
        fAng2     = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 32 + nBodyIndex * 28));
        fAng3     = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 36 + nBodyIndex * 28));
        fResidual = SetByteOrder((float*)(mpComponentData[Component6dEulerRes] + 40 + nBodyIndex * 28));
    }
    else
    {
        fX        = (float)SetByteOrder((double*)(mpComponentData[Component6dEulerRes] + 16 + nBodyIndex * 56));
        fY        = (float)SetByteOrder((double*)(mpComponentData[Component6dEulerRes] + 24 + nBodyIndex * 56));
        fZ        = (float)SetByteOrder((double*)(mpComponentData[Component6dEulerRes] + 32 + nBodyIndex * 56));
        fAng1     = (float)SetByteOrder((double*)(mpComponentData[Component6dEulerRes] + 40 + nBodyIndex * 56));
        fAng2     = (float)SetByteOrder((double*)(mpComponentData[Component6dEulerRes] + 48 + nBodyIndex * 56));
        fAng3     = (float)SetByteOrder((double*)(mpComponentData[Component6dEulerRes] + 56 + nBodyIndex * 56));
        fResidual =        SetByteOrder( (float*)(mpComponentData[Component6dEulerRes] + 64 + nBodyIndex * 56));
    }
    return true;
}
...
unsigned int CRTPacket::GetAnalogChannelCount(unsigned int nDeviceIndex)
{
    if (mnMajorVersion == 1 && mnMinorVersion == 0)
    {
        return SetByteOrder((unsigned int*)(mpComponentData[ComponentAnalog] + 8));
    }
    if (mnAnalogDeviceCount <= nDeviceIndex)
    {
        return 0;
...
unsigned int CRTPacket::GetAnalogData(unsigned int nDeviceIndex, float* pDataBuf, unsigned int nBufSize)
{
    ...
    if (nDeviceIndex < mnAnalogDeviceCount)
    {
        if (mnMajorVersion == 1 && mnMinorVersion == 0)
        {
            nSize = GetAnalogChannelCount(nDeviceIndex);
        ...
        {
            nSize = GetAnalogChannelCount(nDeviceIndex) * GetAnalogSampleCount(nDeviceIndex);
            if (nBufSize < nSize || pDataBuf == NULL)
            {
                nSize = 0;
            }
                              ...
                              float &fAnalogValue)
{
    if (nDeviceIndex < mnAnalogDeviceCount)
    {
        if (GetAnalogChannelCount(nDeviceIndex) > nChannelIndex &&
            GetAnalogSampleCount(nDeviceIndex)  > nSampleIndex)
        {
            if (mnMajorVersion == 1 && mnMinorVersion == 0)
            {
            ...
            else
            {
                fAnalogValue = SetByteOrder((float*)(mpAnalogData[nDeviceIndex] + 16 +
                               (nChannelIndex * GetAnalogSampleCount(nDeviceIndex) + nSampleIndex) * sizeof(float)));
            }
...
double CRTPacket::SetByteOrder(double* pfData)
{
    ...
    /*if (mbBigEndian)
    {
        nTmp = (((unsigned long)(ntohl((long)*((unsigned long*)pfData))) <<  32) +
            ntohl(*((unsigned long*)pfData) >> 32));
        return *((double*)&nTmp);
    }*/
    return *pfData;
} // SetByteOrder
...
unsigned long CRTPacket::SetByteOrder(unsigned long* pnData)
{
    /*if (mbBigEndian)
    {
        return ((unsigned long)(ntohl((long)*pnData)) <<  32) + ntohl(*pnData >> 32);
    }*/
    return *pnData;
} // SetByteOrder
